...
$aksi="modul/mod_listkategori/aksi_listkategori.php";
switch($_GET[act]){
  // Tampil Produk
  default:
    echo "<h2>Produk Kategori</h2>
          <input type=button value='Tambah Produk' onclick=\"window.location.href='?module=produk&act=tambahproduk';\">
          <table>
          <tr><th>no</th><th>nama_kategori</th><th>nama produk</th><th>Serial Number</th><th>berat(kg)</th><th>harga</th><th>diskon(%)</th><th>stok</th><th>tgl. masuk</th><th>aksi</th></tr>";
