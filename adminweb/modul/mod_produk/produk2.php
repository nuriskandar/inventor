...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Produk</h2>
          ...
          <table>
          <tr><th>no</th><th>nama produk</th><th>Model</th><th>Serial Number</th><th>part number</th><th>berat(kg)</th><th>harga</th><th>diskon(%)</th><th>stok</th><th>tgl. masuk</th><th>aksi</th></tr>";
  ...
  case "tambahproduk":
    echo "<h2>Tambah Produk</h2>
		  ...
		  <tr><td width=100>Model</td>     <td> : <input type=text name='model' size=60></td></tr>
		  <tr><td width=100>Serial Number</td>     <td> : <input type=text name='serial_number' size=60></td></tr>
		  <tr><td width=100>Part Number</td>     <td> : <input type=text name='part_number' size=60></td></tr>
