  ...
  while ($r=mysql_fetch_array($sql)){
    ...
    echo "<div class='prod_box'>
          ...
          <div class='bottom_prod_box'></div>
          		<div style='color:#ff6600; font-size:14px' class='prod_cart'>Stok : $stok</div>
            </div>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  echo "<tr><td colspan=5 align=right><br><b>Total</b>:</td><td colspan=2><br>Rp. <b>$total_rp</b></td></tr>
        ...
        <td colspan=4 align=right><br /><a href='selesai-order.html' class='button'>Selesai Order</a></a><br /></td></tr>
        </tbody></table></form><br />
